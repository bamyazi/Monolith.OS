...
{
  public class JUMP_LESS_THAN_Instruction : BaseInstruction, ILabeledInstruction
  {
    private MonoLangParser.NameContext _nameContext;
    private uint _address;
    public JUMP_LESS_THAN_Instruction(MonoLangParser.AddressContext context)
    {
    ...
    {
      if (context.EqualityFlag != EqualityFlag.Less) return;
