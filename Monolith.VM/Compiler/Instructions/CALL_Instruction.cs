...
{
  public class CALL_Instruction : BaseInstruction, ILabeledInstruction
  {
    private MonoLangParser.NameContext _nameContext;
    private uint _address;

    public CALL_Instruction(MonoLangParser.AddressContext context)
    {
    ...
    {
      context.AddressStack.Push(context.InstructionPointer);
